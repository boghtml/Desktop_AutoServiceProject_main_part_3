...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen):
        ...
        self.label_title.setGeometry(QtCore.QRect(60, 30, 511, 91))
        font = QtGui.QFont()
        ...
        self.label_description.setStyleSheet("color: rgb(218, 218, 218);")
        ...
        self.label_credits.setGeometry(QtCore.QRect(10, 350, 631, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        SplashScreen.setWindowTitle(_translate("SplashScreen", "DownloadForm"))
        self.label_title.setText(
            _translate("SplashScreen", "<html><head/><body><p>Auto Service</p><p><br/></p><p><br/></p></body></html>"))
        ...
        self.label_credits.setText(_translate("SplashScreen",
                                              "<html><head/><body><p><span style=\" font-weight:600;\">Created</span>: Andrii Rybak Viktorovich</p></body></html>"))
