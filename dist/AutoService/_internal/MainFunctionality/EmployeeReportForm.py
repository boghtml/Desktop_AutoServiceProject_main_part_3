...
from DataBase.DataBase import get_busy_employees, set_worker_free, get_busy_employees_ids
from FormDesign.FormHandlers.EmployeeReportForm_design import Ui_Form  # Імпортуємо UI клас
